...
const gui_sketch = function(my) {
  ...
  my.setup = function() {
    ...
    my.color2 = color(170,176,180);
    my.color3 = color(220,229,234);
  ...
  my.addElement = function({type,label,mapto, x,y,min,max,curve,value,prev,size,color,showLabel,showValue,bipolar,radioOptions,horizontal}) {
    ...
    if (update == false){
      ...
      elements.push(new UserElement(type,label,mapto,my.scaleX(x),my.scaleY(y),min,max,curve,value,prev,size,color,showLabel,showValue,bipolar,radioOptions,horizontal));
    }
