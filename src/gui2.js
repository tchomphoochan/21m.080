...
let canvas_ids = ["Canvas1", "Canvas2", "Canvas3"];

const gui_sketch = function(my) {

  // x_size = document.getElementById("Canvas1").offsetWidth *.985;
  // y_size = document.getElementById("Canvas1").offsetHeight *.99;
  ...
  my.setup = function() {
    ...
    // COLOR VARS
    my.whiteColor = my.color(255);
    my.blackColor = my.color(0);
    my.transparentColor = my.color(0,0);
    my.color1 = my.color(255,40,0);
        ...
        for (let track =0; track < 4; track++){
          ...
          for (let step =0; step < 8; step++){
            ...
            if (dragging == true){
              ...
              if ((my.mouseX > x && my.mouseX < x+my.boxSize) && (my.mouseY > y && my.mouseY < y+my.boxSize)){
