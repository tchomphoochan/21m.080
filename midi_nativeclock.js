...
var tempo = 120;
var durInd = 0;
var ppqTime = 60 / tempo / 24 * 1000;
// var timePerLoop = 50;
// var timeUnitsPerBeat = 60 / tempo * timePerLoop / 1000;
...
function onMIDISuccess(midiAccess) {
	...
	// midiAccess.inputs.get('input-0').onmidimessage = getMIDIMessage;
...
window.setInterval(checkSeqs, ppqTime);
...
class Seq {
	...
	timeForNext() {
		...
		if (this.timeSinceLast >= nextStep*24) {
			return true;
		} else {
			return false;
		}
